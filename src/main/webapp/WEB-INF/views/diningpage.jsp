...
<link rel="stylesheet" href="css/responsive.css">
    ...
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="css01/responsive.css">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css01/custom.css">
...
<body class="home-v3">
	...
	<!-- mainbody -->
	<jsp:include page="dh/dining.jsp"></jsp:include>
	<!-- footer -->
	...
	<script src="js/bootstrap.min.js"></script>
    <!-- ALL PLUGINS -->
	<script src="js01/jquery.superslides.min.js"></script>
	<script src="js01/images-loded.min.js"></script>
	<script src="js01/isotope.min.js"></script>
	<script src="js01/baguetteBox.min.js"></script>
	<script src="js01/form-validator.min.js"></script>
    <script src="js01/contact-form-script.js"></script>
    <script src="js01/custom.js"></script>
	<!-- Scripts Js End -->
</body>
</html>