	...
	<header class="main-header">
			...
			<a href="index.html" class="logo">
				...
				<b class="logo-mini"><span class="light-logo"><img
						src="../admin_resource/images/logo-light.png" alt="logo"></span><span
					class="dark-logo"><img src="../admin_resource/images/logo-dark.png"
						alt="logo"></span></b>
			<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><img
					src="../admin_resource/images/logo-light-text.png" alt="logo" class="light-logo"><img
					src="../admin_resource/images/logo-dark-text.png" alt="logo" class="dark-logo"></span>
			</a>
			<!-- Header Navbar -->
					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu inner-content-div">
										<li>
											...
											<a href="#"><div class="pull-left">
													<img src="../admin_resource/images/user2-160x160.jpg"
										...
										<li><a href="#"><div class="pull-left">
													<img src="../admin_resource/images/user3-128x128.jpg"
														class="rounded-circle" alt="User Image">
												</div>
												<div class="mail-contnet">
													<h4>
										...
										<li><a href="#"><div class="pull-left">
													<img src="../admin_resource/images/user4-128x128.jpg"
														class="rounded-circle" alt="User Image">
												</div>
												<div class="mail-contnet">
													<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"><img
								src="../admin_resource/images/user5-128x128.jpg"
